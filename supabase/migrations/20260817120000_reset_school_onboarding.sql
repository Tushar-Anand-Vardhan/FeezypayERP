-- Reset one school's onboarding: wipe school-scoped operational rows,
-- restore the school-admin login, and set onboarding_status = in_progress.
-- Keeps the school id + name. Caller must be that school's school_admin.
...
comment on function public.reset_school_onboarding(uuid) is
  'School-admin only. Wipes school-scoped operational data and restarts the onboarding wizard. Keeps school id, name, and admin login.';
